...
export const previewCart = {
	...
	items: [
		...
		},
		{
			...
			prices: {
				...API_SITE_CURRENCY,
				price: displayForMinorUnit( displayWithTax ? '1200' : '1000' ),
				regular_price: displayForMinorUnit(
					displayWithTax ? '1200' : '1000'
				),
				sale_price: displayForMinorUnit(
					displayWithTax ? '1200' : '1000'
				),
			...
			totals: {
				...API_SITE_CURRENCY,
				line_subtotal: displayForMinorUnit( '1000' ),
				line_subtotal_tax: displayForMinorUnit( '200' ),
				line_total: displayForMinorUnit( '1000' ),
				line_total_tax: displayForMinorUnit( '200' ),
			},
			extensions: {},
			item_data: [],
		},
