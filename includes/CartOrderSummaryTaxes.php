<?php
/**
 * Modify the Cart Order Summary Taxes Block.
 *
...
class CartOrderSummaryTaxes {

	public static function attach_hooks() {
		add_filter( 'block_type_metadata', array( __CLASS__, 'modify_metadata' ) );
		add_filter( 'render_block_woocommerce/cart-order-summary-taxes-block', array( __CLASS__, 'modify_block' ), 10, 3 );
	}
	...
	public static function modify_block( $content, $parsed_block, $instance ) {
		...
		if ( $p->next_tag( array( 'class_name' => 'wp-block-woocommerce-cart-order-summary-taxes-block' ) ) ) {
